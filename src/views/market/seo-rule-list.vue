            ...
            <i-col :md="24" :lg="24">
                <i-card dis-hover>
                    <i-row :gutter="10" :style="{marginBottom: '10px'}">
                        <a href="#/market/add-seo-rule">
                            <i-button type="primary">添加SEO规则</i-button>
                        </a>
                    </i-row>
                    <i-row :gutter="10" :style="{marginBottom: '10px'}">
        ...
        data () {
            return {
                ...
                data: [
                    {
                        name: '模板title',
                        demo: 'cmseasy免费企业网站程序是国内首款免费营销型的企业网站系统 | cms网站',
                        rule: '{$title} {$seoContent}',
                        module: '模板',
                        type: 'title'
                    },
                    {
                        name: '模板keywords',
                        demo: '企业网站模板,网站模板,php7网站模板,免费网站模板',
                        rule: '规则1221',
                        module: '栏目1221',
                        type: 'keyword'
                    }
